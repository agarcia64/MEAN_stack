...
export class InputUserDataFormComponent implements OnInit {
  ...
  // Validator functions for every input
  // There is registered and submitted bools in the component to indicate the form's state
  invalidFirstName() {
  ...
  // Each FormControl has a default value and a set of validators
  ngOnInit() {
